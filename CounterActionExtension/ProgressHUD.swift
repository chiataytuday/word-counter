...
class LoadingUIView {
    ...
    class func getProgressBar(view: UIView, msg: String, indicator: Bool ) -> UIView {
        ...
        let msgSize: CGSize = msgNSString.sizeWithAttributes([NSFontAttributeName: UIFont.systemFontOfSize(17.0)])
